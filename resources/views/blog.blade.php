                ...
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <div class="navbar-bottom">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <a class="navbar-brand" href="#"><img src="{{asset('frontend/assets/images/logo.svg')}}" alt="" /></a>
                                </div>
                                <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8  grid-margin">
                                                ...
                                                <div class="fs-13 mb-2">
                                                    <span class="mr-2">{{ $post->users->name }} </span>{{ $post->created_at->diffForHumans() }}
                                                </div>
                                                <p class="mb-0">
                                                    {{$post->content}}
                                                </p>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    <div class="fs-14 font-weight-600">
                                        © 2020 @ <a href="https://www.bootstrapdash.com/" target="_blank"
                                            class="text-white"> BootstrapDash</a>. All rights reserved.
                                    </div>
                                    <div class="fs-14 font-weight-600">
